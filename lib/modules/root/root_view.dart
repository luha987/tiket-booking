import 'package:booking_tiket/modules/home/home_view.dart';
import 'package:booking_tiket/modules/setting/settings_view.dart';
import 'package:booking_tiket/modules/transaction/transaction_history_view.dart';
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: CustomBottomNavBar(
          ...
          label: const ["Depan", "Transaksi", "Pengaturan"],
          onChange: (val) {
            setState(() {
              _currentIndex = val;
            });
